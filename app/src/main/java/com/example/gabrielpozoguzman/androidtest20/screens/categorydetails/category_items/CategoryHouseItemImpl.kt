...
import com.example.gabrielpozoguzman.androidtest20.categories.CategoryHouse
import com.example.gabrielpozoguzman.androidtest20.common.BaseMvcView

class CategoryHouseItemImpl(inflater: LayoutInflater, parent: ViewGroup) : BaseMvcView(), CategoryDetailsItemViewMvc {
    init {
    ...
    override fun bindCategoryDetails(categoryDetailType: CategoryDetailType) {
        Log.d("Gabriel", "Name of the house: ${(categoryDetailType as CategoryHouse).name}")
    }

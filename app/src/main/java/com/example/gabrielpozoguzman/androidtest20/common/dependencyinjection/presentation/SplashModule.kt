...
class SplashModule {
    @Provides
    fun getFetchCategoriesUseCase2(mobgenApi: MobgenApi, categoriesUseRepository: CategoriesUseRepository, defaultCoroutines: DefaultCoroutines): FetchCategoriesUseCase2 {
        return FetchCategoriesUseCase2(mobgenApi, categoriesUseRepository, defaultCoroutines)
    }
}
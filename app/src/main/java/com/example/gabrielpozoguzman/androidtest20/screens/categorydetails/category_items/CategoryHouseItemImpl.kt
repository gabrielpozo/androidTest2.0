...
class CategoryHouseItemImpl(mLayoutInflater: LayoutInflater, parent: ViewGroup) : BaseMvcView(), CategoryDetailsItemViewMvc {
    override fun bindCategoryDetails(categorySchema: CategoryDetailType) {
    }
